...
2) “как” and “будто” seem to be stylistically neutral and should have even distribution in texts of all genres;

3) “а-ля” is expected to occur in the texts of colloquial style.

The other group of hypotheses is devoted to the date of the texts:

1) We believe that the usage of all comparative function words in texts depends on the date of the text. We expect “аки”, “словно” and “подобно”  to appear in the texts written earlier than the XX century more often than other words. “как”, “а-ля” and “будто”  are supposed to occur more often in the XX-XXI centuries;
...
the usage of the words under consideration does not correlate with the style or date;

the usage of a particular part of speech after the comparative words does not correlate with the historical period when the text was written
